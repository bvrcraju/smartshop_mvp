...
export type AuthenticationInput = {
  ...
  firebase?: Maybe<FirebaseAuthInput>;
};
...
export type Mutation = {
  ...
  addSpinRewardsToActiveCustomer?: Maybe<Customer>;
  applyDefaultPromotions: Success;
  removeDefaultPromotions: Success;
  cancelOrder: CancelOrderResult;
  checkInIntoMall?: Maybe<MallEntry>;
  checkOutOfMall?: Maybe<MallEntry>;
};
...
export type MutationaddSpinRewardsToActiveCustomerArgs = {
...
export type MutationcheckInIntoMallArgs = {
...
export type Query = {
  ...
  getNearbyMalls: ShoppingMallList;
};
...
export type QuerygetNearbyMallsArgs = {
...
export type ResetPasswordResult = CurrentUser | PasswordResetTokenInvalidError | PasswordResetTokenExpiredError | NativeAuthStrategyError | NotVerifiedError;
...
export type ShopingMallListOptions = {
  lat: Scalars['Float'];
  lng: Scalars['Float'];
  radius: Scalars['Int'];
};
...
export type SpinRewardsInput = {
  rewards: Scalars['Int'];
};

export type SpinWheelRewardSettings = {
  __typename?: 'SpinWheelRewardSettings';
  spinWheelRewards: Array<Scalars['Int']>;
  numberOfSpinsLimit?: Maybe<Scalars['Int']>;
  numberOfSpinsLimitFrequency: Scalars['String'];
};
